...
class InfoBottomSheet {
  infoBottomSheet(BuildContext context,
      {AnimationController? animationController, required String infoText}) {
        ...
        Consumer<EPrescriptionProvider>(
            builder: (context, appointmentProvider, _) {
              return Padding(
                ...
                child: Container(
                  height: Responsive(context).isTabletLandscape? size.height*0.9:Responsive(context).isTabletPortrait? size.height*0.5:size.height * 0.35,
