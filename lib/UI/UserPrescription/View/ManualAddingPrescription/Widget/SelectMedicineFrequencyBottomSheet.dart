...
class SelectMedicineFrequencyBottomSheet {
  selectMedicineFrequencyBottomSheet(BuildContext context,
                      ...
                      children: [
                        ...
                        Center(
                          child: DualScrollSpinner(
                            leftItems: List.generate(30, (index) => "${(index + 1)} times ".toString()),
