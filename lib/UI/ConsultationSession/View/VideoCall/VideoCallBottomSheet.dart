...
class VideoCallBottomSheet {
  videoCallBottomSheet(BuildContext context, {AnimationController? animationController}) {
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Confirm starting your Video session?',
                      textAlign: TextAlign.center,
              ...
              CustomFilledButton(
                ...
                onPressed: () {
                  ...
                  Future.delayed(Duration(milliseconds: 200),
                      () => Navigator.of(context).pushNamed(RouteConstants.videoCallScreen));
                },
              ),
            ],
          ),
